...

{
    'dimension': 384 ,
    'index_fullness' :0.0,
    'namespaces' :{'':{'vector_count':7027}},
    'total_vector_count' :7027
}
...
docsearch = langchain_pinecone.PineconeVectorStore.from_texts([t.page_content for t in text_chunks],embeddings,index_name="************************************")
